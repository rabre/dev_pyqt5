...
class Fenetre4(QMainWindow):
    def __init__(self):
        ...
        self.text1.setPlaceholderText("Veuiller entrer ID livre")

        self.label2 = QLabel("Ref ",self.centralWidget)
        self.text2 = QLineEdit(self.centralWidget)
        self.text2.setPlaceholderText("Veuiller entrer le reference de livre")
    ...
    def requete(self,xtuple):
        ...
        try:
            cur.execute("INSERT INTO lire (id,ref) VALUES(?,?)",xtuple)
    ...
    def requete_affichage(self):
        con = sqlite3.connect("biblio.db")
        res = con.execute("select * from lire")
